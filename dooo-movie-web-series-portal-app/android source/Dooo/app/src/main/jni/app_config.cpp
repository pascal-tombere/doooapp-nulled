...
std::string SERVER_URL = "https://moviesfreeapp.000webhostapp.com/"; //Copy API SERVER URL From Admin Panal->API Setting And Paste Here
std::string API_KEY = "0QsiqroWlvkU3EZb"; //Copy API KEY From Admin Panal->API Setting And Paste Here
