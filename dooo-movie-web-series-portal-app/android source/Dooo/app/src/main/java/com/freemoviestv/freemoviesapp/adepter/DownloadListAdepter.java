...
public final class DownloadListAdepter extends RecyclerView.Adapter<DownloadListAdepter.ViewHolder> {
    ...
    public void onBindViewHolder(@NonNull final ViewHolder holder, int position) {
        ...
        switch (status) {
                    ...
                    AlertDialog.Builder builder = new AlertDialog.Builder(context)
                            ...
                            .setItems(items, (dialog, which) -> {
                                ...
                                if(which == 0) {
                                    ...
                                    intent.putExtra("url", downloadData.download.getFile());
            ...
            case DOWNLOADING:
            case QUEUED: {
                holder.actionButton.setImageDrawable(ContextCompat.getDrawable(context, R.drawable.fetch_notification_pause));
                holder.actionButton.setOnClickListener(view -> {
                    holder.actionButton.setEnabled(false);
