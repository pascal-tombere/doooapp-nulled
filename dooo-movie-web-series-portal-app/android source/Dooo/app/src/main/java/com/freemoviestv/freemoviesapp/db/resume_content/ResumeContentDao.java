...
public interface ResumeContentDao {
    ...
    @Query("SELECT * FROM ResumeContent")
    ...
    @Query("UPDATE ResumeContent SET source_type = :source_type, source_url = :source_url, type = :type WHERE id = :id")
    void updateSource(String source_type, String source_url, int type, int id);
